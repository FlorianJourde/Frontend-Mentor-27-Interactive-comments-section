...
export default function Background() {
  return (
    <>
      <div className="background absolute w-full h-full top-0 left-0 overflow-hidden bg-[url('/assets/patterns/dot-pattern.png')] bg-[length:50px_50px] md:bg-[length:100px_100px] bg-repeat bg-center">
